...
async def main():
    ...
    database_agent = factory.create_database_agent( system_message=("""
            ...
            Your task:
            1. Connect to the MySQL database 'agentic_db'
            2. Query the 'RegistrationDetails' table to get a random record. If table not exist, create it and insert sample data with fields: userEmail, userPassword, userMobile.
            3. Query the 'Usernames' table to get additional user data. If table not exist, create it and insert sample data with fields: userEmail, userPassword, userMobile.
    ...
    excel_agent = factory.create_excel_agent( system_message=(f"""
            ...
            5. Open {os.getenv("EXCEL_FILE_PATH")}
